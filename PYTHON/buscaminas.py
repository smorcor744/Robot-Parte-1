...
def revelar_celda(tablero, celdas_reveladas:set, celdas_marcadas:set, fila, columna) -> bool:
    """
...
def revelar_celdas_vacias(tablero, celdas_reveladas:set, celdas_marcadas:set, fila, columna):
    """
...
def marcar_celda(celdas_marcadas:set, fila, columna):
    """
